...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="w3-container">
        ...
        <div class="row" >
            ...
            <div class="col-md-3 col-sm-3" style="padding:20px 20px;color:white;">

                  <center><h3 class="page-header"><%#Eval("PizzaName")%></h3></center>

                  <img src="<%#Eval("PizzaImagePath") %>" alt="Avatar" style="width:200px;height:130px;border-radius:10px;">
